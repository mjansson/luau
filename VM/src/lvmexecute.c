...
LUAU_NOINLINE static int luau_loopFORG(lua_State* L, int a, int c)
{
    StkId ra = &L->base[a];
...
#endif
        {
            ...
            VM_CASE(LOP_GETIMPORT)
            {
                ...
                else
                {
                    ...
                    VM_PROTECT(luaV_getimport(L, cl->env, k, aux, /* propagatenil= */ 0));
            ...
            VM_CASE(LOP_FASTCALL1)
            {
                ...
                if (cl->env->safeenv && f)
                {
                    ...
                    int n = f(L, ra, arg, nresults, 0, nparams);
